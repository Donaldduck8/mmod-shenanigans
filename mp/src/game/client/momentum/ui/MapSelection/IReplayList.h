#ifndef IREPLAYLIST_H
#define IREPLAYLIST_H
#ifdef _WIN32
#pragma once
#endif

//Used by replaydisplay_t, holds map information for filtering and displaying
struct replaystruct_t
{
...
struct replaydisplay_t
{
    replaydisplay_t()
    {
        ...
        m_mMap = replaystruct_t();
    }
    replaystruct_t m_mMap;         // the map struct, containing the information for the map
    ...
    bool operator==(const replaydisplay_t &rhs) const { return rhs.m_iServerID == m_iServerID; }
};
...
public:
    ...
    virtual replaystruct_t *GetMap(unsigned int serverID) = 0;
