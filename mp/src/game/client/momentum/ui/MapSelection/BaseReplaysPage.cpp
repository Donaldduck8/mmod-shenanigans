...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CBaseReplaysPage::CBaseReplaysPage(vgui::Panel *parent, const char *name, const char *pCustomResFilename)
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CBaseReplaysPage::~CBaseReplaysPage()
{
}
...
// Purpose: 
//-----------------------------------------------------------------------------
int CBaseReplaysPage::GetInvalidMapListID()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseReplaysPage::PerformLayout()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseReplaysPage::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
replaystruct_t *CBaseReplaysPage::GetMap(unsigned int serverID)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseReplaysPage::CreateFilters()
{
...
//-----------------------------------------------------------------------------
/*void CBaseReplaysPage::ServerResponded(gameserveritem_t &server)
{
...
//-----------------------------------------------------------------------------
/*void CBaseReplaysPage::ServerResponded(int iServer)
{
/*
#ifndef NO_STEAM
...
//********
/*void CBaseReplaysPage::ServerResponded(int iServer, gameserveritem_t *pServerItem)
{
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::OnButtonToggled(Panel *panel, int state)
{
    if (panel == m_pFilter)
    {
        int wide, tall;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseReplaysPage::UpdateDerivedLayouts(void)
{
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::OnTextChanged(Panel *panel, const char *text)
{
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::UpdateStatus()
{
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::UpdateFilterSettings()
{
    //Gamemode
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::OnSaveFilter(KeyValues *filter)
{
}
...
// Purpose: allow derived classes access to the saved filter string
//-----------------------------------------------------------------------------
void CBaseReplaysPage::OnLoadFilter(KeyValues *filter)
{
}
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::RecalculateFilterString()
{
...
//-----------------------------------------------------------------------------
bool CBaseReplaysPage::CheckPrimaryFilters(replaystruct_t &map)
{
...
//-----------------------------------------------------------------------------
bool CBaseReplaysPage::CheckSecondaryFilters(replaystruct_t &map)
{
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::SetRefreshing(bool state)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseReplaysPage::OnCommand(const char *command)
{
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::OnItemSelected()
{
    if (m_pMapList->GetSelectedItemsCount() < 1)
    {
        m_pStartMap->SetEnabled(false);
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::OnKeyCodePressed(vgui::KeyCode code)
{
    if (code == KEY_F5)
    {
        StartRefresh();
...
//-----------------------------------------------------------------------------
bool CBaseReplaysPage::OnGameListEnterPressed()
{
    return false;
}
...
//-----------------------------------------------------------------------------
int CBaseReplaysPage::GetSelectedItemsCount()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
/*void CBaseReplaysPage::ServerFailedToRespond(int iServer)
{
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::RemoveMap(replaydisplay_t &map)
{
    if (m_pMapList->IsValidItemID(map.m_iListID))
    {
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::OnRefreshServer(int serverID)
{
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::StartRefresh()
{
    //ClearServerList();
    //SetRefreshing(true);
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::GetNewMapList()
{
    StartRefresh();
}
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::StopRefresh()
{
    // clear update states
    m_iServerRefreshCount = 0;
#ifndef NO_STEAM
...
//-----------------------------------------------------------------------------
bool CBaseReplaysPage::IsRefreshing()
{
    //MOM_TODO: 
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::OnPageShow()
{
    StartRefresh();
}
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::OnPageHide()
{
    StopRefresh();
}
...
//-----------------------------------------------------------------------------
void CBaseReplaysPage::OnViewMapInfo()
{
    if (!m_pMapList->GetSelectedItemsCount())
        return;
